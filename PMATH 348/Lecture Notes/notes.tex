...
have $\psi(a) = a$. This implies that $\phi \in \Aut_E^G(E)$. Thus
\begin{equation*}
\Aut_E^G(E) = \Aut_F(E).
\end{equation*}
...
\begin{equation*}
|Aut_F(E)| = [E:F] \quad\text{and}\quad |Aut_E^G(E)| = [E:E^G] 
\end{equation*}
It follows that since $[E:E^G] = [E:F]$. Since $[E:F]=[E:E^G]=[E^G:F]$, we have
